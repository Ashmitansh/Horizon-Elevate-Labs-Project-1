      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div 
              ref={formRef}
              className="bg-white rounded-lg shadow-md p-8 transition-all duration-1000 opacity-0 transform translate-y-12"
            >
              {submitSuccess ? (
            ...
            <div className="bg-blue-600 rounded-lg shadow-md p-8 text-white">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-lg">contact@horizoncompany.com</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-lg">123 Innovation Drive<br />San Francisco, CA 94107</p>
                </div>
                <div>
                  <p className="text-blue-200 mb-1">Working Hours</p>
                  <p className="text-lg">Monday - Friday: 9AM - 6PM<br />Weekend: Closed</p>
                </div>
              </div>
              <div className="mt-8">
